...
export default function ForgettingCurve() {
  ...
  const fillD = `M${px(0)},${py(1)} ${points} L${px(14)},${py(0)} L${px(0)},${py(0)} Z`;
  ...
  return (
    ...
    <div className="bg-surface border border-border rounded-2xl p-6 shadow-2xl">
      ...
      <div className="p-2 bg-background rounded-xl border border-border mb-4">
        ...
        >
          {/* Axes */}
          <line x1="36" y1="12" x2="36" y2="244" stroke="rgba(255,255,255,.22)" strokeWidth="1"/>
          <line x1="36" y1="244" x2="540" y2="244" stroke="rgba(255,255,255,.22)" strokeWidth="1"/>
          ...
          <defs>
            <linearGradient id="curveGradient" x1="0" y1="0" x2="1" y2="0">
              ...
              <stop offset="1" stopColor="var(--color-primary)" stopOpacity="0.7" />
            </linearGradient>
          ...
          <g fill="rgba(0,0,0,0.7)" fontSize="12">
            {/* X-axis */}
            {[0,7,14].map(d => (
              <text key={d} x={px(d)} y="270" textAnchor="middle">{d} days</text>
            ))}
            {/* Y-axis */}
            <text x={34} y={py(1) - 6} textAnchor="end">100%</text>
            <text x={36} y={py(0) + 4} textAnchor="end">0%</text>
          </g>
      ...
      <div className="flex justify-between items-center gap-3 mb-3">
        ...
        <div className="relative flex-1 mx-3">
          <input 
            ...
            style={{
              background: `linear-gradient(to right, var(--color-primary) 0%, var(--color-primary) ${day / 14 * 100}%, rgba(255,255,255,0.2) ${day / 14 * 100}%, rgba(255,255,255,0.2) 100%)`,
            }}
          />
          <style jsx>{`
