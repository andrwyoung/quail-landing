export default function TermsPage() {
  return (
    <main className="prose mx-auto max-w-3xl font-body font-medium px-6 mt-8 py-10">
      ...
      <p className="mb-12">
        Welcome to Quail Reader (“Quail,” “we,” “us,” or “our”). These Terms of
        Service (“Terms”) govern your access to and use of our website at{" "}
      ...
      <p className="mb-12">
        ...
        jurisdiction) to use the Service. By using Quail, you represent that you
      ...
      <ul className="list-disc pl-6 mb-12 space-y-2">
        ...
        <li>
          Do not attempt to gain unauthorized access to other accounts or data.
        </li>
      </ul>
      ...
      <p className="mb-12">
        ...
        Stripe. You agree to provide accurate payment information and authorize
        us (through Stripe) to charge you according to your selected plan. Fees
      ...
      <p className="mb-12">
        ...
        Quail or its licensors. You may not copy, modify, distribute, or create
      ...
      <p className="mb-12">
        ...
        not guarantee the Service will be uninterrupted, secure, or error-free.
      </p>
      ...
      <p className="mb-12">
        ...
        to conflict-of-law provisions. Disputes shall be resolved in the courts
      ...
      <p className="mb-12">
        ...
        posted on this page. We will notify you of material changes via the
