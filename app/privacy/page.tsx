export default function PrivacyPage() {
  return (
    <main className="prose mx-auto max-w-3xl font-body font-medium px-6 mt-8 py-10">
      ...
      <ul className="list-disc pl-6 mb-12 space-y-2">
        ...
        <li>
          ...
          Stripe. We receive limited billing metadata (e.g., subscription tier,
          status) but <em>we do not store full card numbers</em>. Card data is
          handled by Stripe per its own policies.
        </li>
        <li>
      ...
      <p className="mb-12">
        ...
        remember preferences, and measure usage. Some cookies and local storage
        are required for core functionality—like keeping you signed in. You can
        control or delete cookies in your browser settings, but disabling them
        may limit essential functions of the Service.
      </p>
      ...
      <ul className="list-disc pl-6 mb-12 space-y-2">
        ...
        <li>
          <strong>Stripe</strong> (payments and subscription management). Stripe
          may set cookies or collect data per its own policy.
        </li>
        <li>
          <strong>Apple/Google Sign-In</strong> (OAuth). When you use these
          options, your sign-in is governed by Apple/Google’s terms and privacy
          policies.
        </li>
      </ul>
      <p>
      ...
      <p className="mb-12">
        Our Service may link to third-party websites. We are not responsible for
        their content or privacy practices. Review their policies before
      ...
      <p className="mb-12">
        ...
        and restricted access controls, to protect your information. However, no
        method of transmission or electronic storage is 100% secure, and we
      ...
      <p className="mb-4">
        ...
        meet legal obligations. You may request access, correction, or deletion
      ...
      <p className="mb-12">
        ...
        correct, port, delete, or object to certain processing of your personal
        ...
        . We will verify your request and respond in accordance with applicable
        law.
      </p>
