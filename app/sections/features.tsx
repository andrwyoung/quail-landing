...
const features: {
  ...
  {
    title: "Fast",
    description: <>Get what you want to know right away</>,
    icon: <FaBoltLightning />,
  },
  {
    title: "Flexible",
    description: <>Support for newsletters, documents, epubs, and more</>,
    icon: <FaBook />,
  },
  {
    title: "Beautiful",
  ...
  return (
    <>
      {features.map((feature) => (
        <div key={feature.title} className="p-6 rounded-lg bg-background">
